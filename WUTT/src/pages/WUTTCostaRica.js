...
import styles from "./WUTTCostaRica.module.css";
const WUTTCostaRica = () => {
  ...
  return (
    <div className={styles.wuttCostarica}>
      <img
        className={styles.newBacktotoppngIcon}
        alt=""
        src="/new-backtotoppng@2x.png"
      />
                    ...
                    <div className={styles.divnewCardsContent}>
                      ...
                      <div className={styles.divcssErkj9oControl}>
                        <img
                          ...
                          alt=""
                          src="/divcss187htnsindicatorcontainer6.svg"
                        />
              ...
              <div className={styles.divnewReasons}>
                ...
                <div className={styles.divcss253u24Control}>
                  <img
                    ...
                    alt=""
                    src="/divcss187htnsindicatorcontainer7.svg"
                  />
      ...
      <div className={styles.costaRicaIsContainer}>
        <span className={styles.createAPersonalizedContainer1}>
          <p className={styles.createAPersonalized}>
            <span className={styles.costaRica}>Costa Rica</span>
            <span className={styles.isADream}>
              {" "}
              is a dream destination for tourists seeking adventure and
              relaxation, offering a perfect blend of pristine beaches,
              thrilling outdoor activities like surfing and ziplining, and
              rejuvenating experiences in natural hot springs.
            </span>
          </p>
        </span>
      </div>
      <div className={styles.recommendSeasonDecemberAWrapper}>
        <div
          className={styles.recommendSeasonDecember}
        >{`recommend season: December - april `}</div>
      </div>
      <b className={styles.welcomeTo}>welcome to:</b>
      <b className={styles.costaRica1}>costa rica</b>
      <b className={styles.howManyDays}>How many days?</b>
      <b className={styles.whatAboutNature}>what about nature?</b>
      <b className={styles.whatAboutCulture}>what about culture?</b>
      <b className={styles.andSomeFood}>and some food?</b>
      <b className={styles.whatIsYour}>What is your trip style?</b>
      <b className={styles.text}>
        <p className={styles.createAPersonalized}>&nbsp;</p>
      </b>
      <img className={styles.image33Icon} alt="" src="/image-34@2x.png" />
      ...
      <img className={styles.maskGroupIcon} alt="" src="/mask-group9@2x.png" />
      <div className={styles.vectorParent}>
        <img className={styles.instanceChild} alt="" src="/rectangle-9.svg" />
        ...
        <img className={styles.instanceItem} alt="" src="/vector-9.svg" />
      </div>
      <div className={styles.vectorGroup}>
        ...
        <div className={styles.days}>
          <span className={styles.costaRica}>{`3-5 `}</span>
          <span className={styles.isADream}>days</span>
        </div>
        <img className={styles.vectorIcon} alt="" src="/vector-11.svg" />
        <img className={styles.instanceChild1} alt="" src="/vector-11.svg" />
        <b className={styles.medium}>medium</b>
        <div className={styles.days2}>
          <span className={styles.costaRica}>{`6-9 `}</span>
          <span className={styles.isADream}>days</span>
        </div>
        <b className={styles.long}>long</b>
        <div className={styles.days4}>
          <span className={styles.costaRica}>{`10-16 `}</span>
          <span className={styles.isADream}>days</span>
        </div>
      </div>
      <div className={styles.vectorContainer}>
        ...
        <div className={styles.cravingAnImmersiveContainer}>
          <span className={styles.createAPersonalizedContainer1}>
            ...
            <p className={styles.createAPersonalized}>nature experience</p>
          </span>
        </div>
        <div className={styles.lookingForAContainer}>
          <p className={styles.createAPersonalized}>Looking for a break</p>
          <p className={styles.createAPersonalized}> from nature's embrace</p>
        </div>
      </div>
      <div className={styles.frameDiv}>
        <img className={styles.instanceChild3} alt="" src="/rectangle-9.svg" />
        <b className={styles.b3}>4</b>
        <img className={styles.instanceItem} alt="" src="/vector-9.svg" />
        <b className={styles.must}>must</b>
        <b className={styles.optional}>optional</b>
        <div className={styles.eagerToIndulgeContainer}>
          <p className={styles.createAPersonalized}>{`Eager to indulge in `}</p>
          <p className={styles.createAPersonalized}>{`an abundance of `}</p>
          <p className={styles.createAPersonalized}>cultural delights</p>
        </div>
        <div className={styles.seekingACulturalContainer}>
          <p className={styles.createAPersonalized}>
            Seeking a cultural break or
          </p>
          <p className={styles.createAPersonalized}> looking for alternative</p>
          <p className={styles.createAPersonalized}> experiences</p>
        </div>
      </div>
      <div className={styles.vectorParent1}>
        ...
        <div className={styles.cravingACulinaryAdventureContainer}>
          <p className={styles.createAPersonalized}>Craving a culinary</p>
          <p className={styles.createAPersonalized}>adventure to savor</p>
          <p className={styles.createAPersonalized}>diverse flavors across</p>
          <p className={styles.createAPersonalized}> multiple restaurants</p>
        </div>
        <div className={styles.selectiveGastronomicExploraContainer}>
          <p className={styles.createAPersonalized}>Selective gastronomic</p>
          <p className={styles.createAPersonalized}> exploration preferred</p>
        </div>
      </div>
      <img
