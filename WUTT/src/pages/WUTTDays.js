...
import styles from "./WUTTDays.module.css";
const WUTTDays = () => {
  ...
  return (
    <div className={styles.wuttDays}>
      ...
      <img className={styles.image40Icon} alt="" src="/image-44@2x.png" />
      <img className={styles.image41Icon} alt="" src="/image-41@2x.png" />
      <img className={styles.image44Icon} alt="" src="/image-44@2x.png" />
      <img className={styles.wuttDaysChild} alt="" src="/vector-18.svg" />
      <img className={styles.image43Icon} alt="" src="/image-44@2x.png" />
      <img className={styles.maskGroupIcon} alt="" src="/mask-group1@2x.png" />
      <b className={styles.yourTripTo}>Your trip to COSTA RICA</b>
      <div className={styles.stunningCombinationOf}>
        stunning combination of pristine beaches, lush rainforests, and abundant
        wildlife, making it a must-visit destination for nature enthusiasts.
      </div>
      <div className={styles.vectorParent}>
        <img className={styles.instanceChild} alt="" src="/rectangle-23.svg" />
        ...
        <div className={styles.stunningCombinationOf1}>
