...
import styles from "./WUTTChoose.module.css";
const WUTTChoose = () => {
  ...
  return (
    <div className={styles.wuttChoose}>
      ...
      <b className={styles.justChooseYour}>
        Just choose your destination and we will do the rest for you!
      </b>
      <img
        ...
        onClick={onLogoClick}
      />
      <img className={styles.maskGroupIcon} alt="" src="/mask-group11@2x.png" />
      <div className={styles.component9}>
        <div className={styles.chooseYourDistentionParent}>
          <b className={styles.chooseYourDistention}>choose your distention</b>
          <img className={styles.frameInner} alt="" src="/polygon-1.svg" />
        </div>
        <div className={styles.rectangleParent}>
          <div className={styles.rectangleDiv} />
          <div className={styles.frameChild1} />
          <div className={styles.canadaParent}>
            <b className={styles.canada}>Canada</b>
            <b className={styles.canada}>India</b>
            <b className={styles.canada}>Japan</b>
            <b className={styles.canada}>Costa Rica</b>
            <b className={styles.canada}>Greece</b>
            <b className={styles.canada}>China</b>
            <b className={styles.canada}>Russia</b>
            <b className={styles.canada}>United Stats</b>
            <b className={styles.canada}>China</b>
            <b className={styles.canada}>Thailand</b>
            <b className={styles.canada}>England</b>
            <b className={styles.canada}>France</b>
            <b className={styles.canada}>Italy</b>
            <b className={styles.canada}>Germany</b>
          </div>
        </div>
      </div>
    </div>
