...
import styles from "./WUTTSummery.module.css";
const WUTTSummery = () => {
  ...
  return (
    <div className={styles.wuttSummery}>
      <div className={styles.newBacktotoppng} />
                ...
                <div className={styles.divscEcqkzk}>
                  ...
                  <div className={styles.divscJlqhrw5}>
                    ...
                    <img
                      className={styles.greeceSmalljpgIcon}
                      alt=""
                      src="/montenegro-smalljpg@2x.png"
                    />
                  </div>
                </div>
                <img
                    ...
                    <div className={styles.divnewCardsContent}>
                      ...
                      <div className={styles.divcssErkj9oControl}>
                        <img
                          ...
                          alt=""
                          src="/divcss187htnsindicatorcontainer.svg"
                        />
              ...
              <div className={styles.divnewReasons}>
                ...
                <div className={styles.divcss253u24Control}>
                  <img
                    ...
                    alt=""
                    src="/divcss187htnsindicatorcontainer1.svg"
                  />
              ...
              <div className={styles.divscGsydnn}>
                ...
                <div className={styles.divscJffhpj1}>
                  <img
                    ...
                    alt=""
                    src="/new-tsachiglobinpng@2x.png"
                  />
      ...
      <img
        ...
        onClick={onLogoClick}
      />
      <img className={styles.image34Icon} alt="" src="/image-342@2x.png" />
      <div className={styles.summeryOfYourTripParent}>
        <b className={styles.summeryOfYour}>Summery Of Your Trip</b>
        <b className={styles.likeYouAskedContainer}>
          <p className={styles.createAPersonalized}>Like you asked:</p>
          <p className={styles.createAPersonalized}>
            {" "}
            4 days trip to Costa Rica
          </p>
        </b>
        <img className={styles.image35Icon} alt="" src="/image-35@2x.png" />
        <div className={styles.tripStyleParent}>
          <b className={styles.tripStyle}>Trip style:</b>
          <div className={styles.relaxed}>relaxed</div>
          <img className={styles.image49Icon} alt="" src="/image-49@2x.png" />
        </div>
        <div className={styles.natureParent}>
          <b className={styles.nature}>Nature:</b>
          <div className={styles.must}>must</div>
          <img className={styles.image45Icon} alt="" src="/image-45@2x.png" />
        </div>
        <div className={styles.cultureParent}>
          <b className={styles.culture}>culture:</b>
          <div className={styles.optional}>optional</div>
          <img className={styles.image46Icon} alt="" src="/image-46@2x.png" />
        </div>
        <div className={styles.foodieParent}>
          <b className={styles.foodie}>foodie:</b>
          <div className={styles.must1}>must</div>
          <img className={styles.image50Icon} alt="" src="/image-50@2x.png" />
        </div>
        <div className={styles.theHighlightOfYourTripParent}>
          <b className={styles.theHighlightOf}>The highlight of your trip:</b>
          <div className={styles.image22Parent}>
            <img className={styles.image22Icon} alt="" src="/image-22@2x.png" />
            <img className={styles.image37Icon} alt="" src="/image-22@2x.png" />
            <img className={styles.image36Icon} alt="" src="/image-22@2x.png" />
            <img className={styles.image38Icon} alt="" src="/image-22@2x.png" />
            <img className={styles.image39Icon} alt="" src="/image-22@2x.png" />
          </div>
        </div>
        <b className={styles.manuelAntonioNationalContainer}>
          <p className={styles.createAPersonalized}>
            Manuel Antonio National Park and the beautiful beaches of the
            Pacific coast
          </p>
          <p className={styles.createAPersonalized}>
            Marino Ballena National Park and a boat trip to Corcovado National
            Park
          </p>
          <p className={styles.createAPersonalized}>
            The fabulous Monteverde Cloud Forest and the hot springs near Arenal
          </p>
          <p className={styles.createAPersonalized}>
            Arenal Volcano National Park and the Maleku indigenous tribe
          </p>
          <p className={styles.createAPersonalized}>
        ...
        <div className={styles.continueParent}>
        ...
        <div className={styles.rePlanWrapper}>
          <b className={styles.continue}>Re-Plan</b>
        </div>
        <b className={styles.day}>Day:</b>
        <b className={styles.description}>description:</b>
        <b className={styles.overNight}>over Night:</b>
        <div className={styles.day1Manuel}>
          Day 1 Manuel Antonio National Park Uvita
        </div>
        <div className={styles.lineDiv} />
        <div className={styles.day2Corocovado}>
          Day 2 Corocovado National Park Uvita
        </div>
        <div className={styles.frameChild1} />
        <div className={styles.day3Fabulous}>
          Day 3 Fabulous Monteverde Cloud Forest Volcano Arenal Area
        </div>
        <div className={styles.frameChild2} />
        <div className={styles.day4Volcano}>
          Day 4 Volcano Poas National Park and Back to San Jose End of trip
        </div>
        <div className={styles.frameChild3} />
        <b className={styles.totalEstimatedCost}>total Estimated cost: 2000$</b>
      </div>
    </div>
  );
};

export default WUTTSummery;
